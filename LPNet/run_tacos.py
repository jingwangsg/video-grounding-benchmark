...
parser.add_argument(
    ...
    type=str,
    default="org",
    help="[new | org], org: the visual feature from Gao et al.",
)
parser.add_argument(
    "--root", type=str, default="data/TACoS", help="root directory for store raw data"
)
parser.add_argument(
...
if configs.mode.lower() == "prepro":
    ...
    # # * hack video feature reading part
    # video_features = load_video_features(max_position_length=configs.max_position_length)
    ...
    with tf.Graph().as_default() as graph:
        ...
        with tf.Session(config=sess_config) as sess:
            optimizer = tf.train.AdamOptimizer(
                configs.init_lr, beta1=0.9, beta2=0.999, name="AdamOptimizer"
            )
